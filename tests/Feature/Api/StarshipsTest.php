...
class StarshipsTest extends TestCase
{
    ...
    {
        $this->mock(SwapiClient::class, function (MockInterface $mock) {
            $guzzle = new GuzzleResponse(body: '{"results": [{"name": "CR90 Corvette", "model": "CR90 Corvette", "url": "http://swapi.test.swapi.orb.local/api/starships/2/","edited": "2014-12-20T21:23:49.867000Z"}]}');
        ...
        $response->assertStatus(200);
        $response->assertContent('{"results":[{"name":"CR90 Corvette","model":"CR90 Corvette","url":"http:\/\/swapi.test.swapi.orb.local\/api\/starships\/2\/","edited":"2014-12-20T21:23:49.867000Z","count":0}]}');
    }
}
